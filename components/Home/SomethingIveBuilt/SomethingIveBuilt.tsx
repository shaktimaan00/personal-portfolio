    ...
    >
      ...
      <div className="flex flex-col   xl:space-y-36 space-y-8 md:space-y-28">
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          >
            <div className="relative rounded w-full h-full col-span-7 ">
              <a href="https://www.rgpv-notess.tech" target={"_blank"} rel="noreferrer">
                <div className="absolute w-full h-full rounded bg-AAprimary 
           transition-opacity opacity-30 hover:opacity-0 hover:cursor-pointer duration-300"
                ></div>
              </a>

              <Img src={"/rgpv.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                ...
                <Img src={"/rgpv.png"} alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-AAsecondary text-base">Free for all</span>
                <a href="https://www.rpgv-notess.tech" target="_blank" rel="noopener noreferrer">
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                ...
                <span className="text-AAsecondary">RGPV Notes</span> is an open-source project, demonstrating our commitment to transparency and collaboration. It has been built using cutting-edge technologies including <span className="text-AAsecondary">Next.js, Firebase</span> and <span className="text-AAsecondary">NextUI</span>. These technologies ensure a seamless, user-friendly experience for all users, regardless of their technical proficiency.
                </p>
              </div>
              <ul
              ...
              >
                ...
                <span className="pr-4 z-10">Google AI</span>
              </ul>
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96 ">
          ...
          >
           ...
           transition-opacity opacity-10 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/typingss.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                <GithubIcon link="https://github.com/shaktimaan00" />
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a href="https://github.com/shaktimaan00" target={"_blank"} rel="noreferrer">
                <div
                  className="absolute w-full h-full rounded bg-AAprimary 
